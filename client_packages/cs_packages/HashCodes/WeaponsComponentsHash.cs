...
{
    public class WeaponsComponentsHash
    {
        public static readonly Dictionary<string, uint?> WeaponsComponentsHashCodes = new Dictionary<string, uint?>
        {
            ...
            {"CeramicpistolClip01", 1423184737u},
            {"CeramicpistolClip02", 2172153001u},
            {"CeramicpistolSupp", 2466764538u},
            {"NavyrevolverClip01", 2556346983u},
        };

        public enum KnuckleComponents: uint
        {
            BaseModel  = 0xF3462F33,
            ThePimp    = 0xC613F685,
            TheBallas  = 0xEED9FD63,
            TheHustler = 0x50910C31,
            TheRock    = 0x9761D9DC,
            TheHater   = 0x7DECFE30,
            TheLover   = 0x3F4E8AA6,
            ThePlayer  = 0x8B808BB ,
        ...
        public enum SwitchbladeComponents : uint
        {
            DefaultHandle    = 	0x9137A500,
            VIPVariant       = 	0x5B3E7DB6,
            BodyguardVariant =  0xE7939662,
        }

        public static readonly Dictionary<string, uint> HeavyRevolverMkIIComponents = new Dictionary<string, uint>()
        {
            {"DefaultRounds"        , 0xBA23D8BE},
            {"TracerRounds "        , 0xC6D8E476},
            {"IncendiaryRounds"     , 0xEFBF25  },
            {"HollowPointRounds"    , 0x10F42E8F},
            {"FullMetalJacketRounds", 0xDC8BA3F },
            {"HolographicSight"     , 0x420FD713},
            {"SmallScope"           , 0x49B2945 },
            {"Flashlight"           , 0x359B7AAE},
            {"Compensator"          , 0x27077CCB},
            {"DigitalCamo"          , 0xC03FED9F},
            {"BrushstrokeCamo"      , 0xB5DE24  },
            {"WoodlandCamo"         , 0xA7FF1B8 },
            {"Skull"                , 0xF2E24289},
            {"SessantaNove"         , 0x11317F27},
            {"Perseus"              , 0x17C30C42},
            {"Leopard"              , 0x257927AE},
            {"Zebra"                , 0x37304B1C},
            {"Geometric"            , 0x48DAEE71},
            {"Boom"                 , 0x20ED9B5B},
            {"Patriotic"            , 0xD951E867},
        };

        public static Dictionary<string, uint> GetWeaponComponentList(uint weaponHash)
        {

            return weaponHash switch
            {
                ((uint)WeaponsHash.WeaponHash.Revolver_mk2) => HeavyRevolverMkIIComponents,
                _ => null,
            };
        }
        ...
        {
            return WeaponsComponentsHashCodes.GetValueOrDefault(name);
        }
    }
}
